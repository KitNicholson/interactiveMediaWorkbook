...
function keyPressed() {
  // Identifies non-text based keys as trigger for string manipulation
  ...
  if (key === "Backspace") {
    ...
    // spawn words when not taking custom type
    spawnText();
  } else if (key === "f") {
    // f triggers fade
    fadeOn = !fadeOn;
  ...
  if (key === "2") {
    globalFont = twoPointH;
  } else if (key === "3") {
    globalFont = twoStrokeA44;
  } else if (key === "4") {
